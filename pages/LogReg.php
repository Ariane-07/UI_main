...
// SuperAdmin has a fixed username and password
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['username'], $_POST['password'])) {
    $username = $_POST['username'];
    $password = $_POST['password'];

    // Check if it's the SuperAdmin logging in
    if ($username === 'SuperAdmin' && $password === 'Admin0773!') {
        $_SESSION['Role'] = 'superadmin'; // Set session role to superadmin
        header('Location: adminPages.php'); // Redirect to admin page
        exit;
    } else {
